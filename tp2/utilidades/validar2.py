def validar2(X, y, metodo, nn, metrica1, metrica2, transf=True):
    ...
    for i, (train_index, test_index) in enumerate(kfold.split(X)):
        ...
        reg_t = metodo(n_neighbors = nn, metric = metrica1, p = metrica2, weights = 'distance', n_jobs = -1)
        ...
        error = round(mean_absolute_error(y_test, predicciones_t))
        print(f"Error de fold N°{i} es : {error}")
