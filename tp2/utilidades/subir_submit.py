def subir(archivo, mensaje, competicion="Inmuebles24"):
    ...
    try:
        ...
        print("Asegurate de tener instalado kaggle crack, sino lo tenes usa algo como: pip install --user kaggle")
    except OSError:
        print("Te olvidaste de generar el archivo de autenticacion para eso segui las instrucciones en:\n\
              https://github.com/Kaggle/kaggle-api#api-credential")
